...
Design status: the benchmark price path runs locally. Trade, forecasts and later
operational controls remain planned. See [data contracts](data-contracts.md) for
the bounded source scope.
